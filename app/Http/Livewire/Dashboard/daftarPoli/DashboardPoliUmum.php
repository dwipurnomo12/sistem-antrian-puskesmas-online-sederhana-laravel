...
class DashboardPoliUmum extends Component
{
    use WithPagination;
    ...
    {
        return view('livewire.dashboard.daftar-poli.dashboard-poli-umum', [
            'poliUmum' => Antrian::where('poli', 'umum')->where('is_call', 0)->paginate(10)
        ]);
    }
